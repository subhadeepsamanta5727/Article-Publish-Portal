import { FilePlus2, FileText, Globe2, Images, LayoutDashboard, LogOut, Menu, MessageSquareQuote, Moon, PackagePlus, Receipt, ShieldCheck, Sun, X } from "lucide-react";
...
export default function AppShell() {
  ...
  const brand = <div className="px-2"><img src={logo} alt="ReleaseMYPR" className="h-10 w-auto max-w-[190px] object-contain object-left" /></div>;
